...
public interface AccionDeConexion {
	void actuaEnListaPj(Actor pj, List<Actor> listaPj, List<Actor> killPjList, Mundo mundo, Socket socket, List<Socket> socketList);//Este método pone/saca al pj en la lista de pjs. 
