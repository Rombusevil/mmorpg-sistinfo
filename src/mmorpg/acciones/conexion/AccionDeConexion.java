...
public interface AccionDeConexion {
	void actuaEnListaPj(Actor pj, List<Actor> listaPj, List<Actor> killPjList, Mundo mundo, Entry<Socket, Boolean> socket, Entry<Socket, Boolean> socketList);//Este método pone/saca al pj en la lista de pjs. 
